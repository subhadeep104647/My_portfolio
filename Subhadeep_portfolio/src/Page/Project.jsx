        ...
        <div className='w-1/2 bg-text2 rounded-r-2xl flex flex-col px-5 py-1 gap-2'>
           ...
           <div className=' flex flex-row items-center justify-between'>
              ...
              <div className=' flex flex-row gap-1'>
                <div><button className="w-8 h-8 rounded-full backdrop-blur-lg bg-white/10 border border-white/20 flex items-center justify-center text-white text-gl hover:scale-110 transition"><a href='https://github.com/DEBUGXIA/DEBUG_XIA'><FaGithub /></a></button></div>
                <div><button className="w-8 h-8 rounded-full backdrop-blur-lg bg-white/10 border border-white/20 flex items-center justify-center text-white text-gl hover:scale-110 transition"><a href='https://www.linkedin.com/posts/subhadeep-biswas-4731732a9_innovatex-innovatex-debugging-ugcPost-7449450591342219264-qak9?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEo9qdcBTyWGiycEl8tgNGY2X85B2ylSEs8'><FaLinkedinIn /></a></button></div>
              </div>
           </div>
      ...
      <div className=' flex flex-row w-full bg-white rounded-2xl border-1 border-gray-600'>
        ...
        <div className='w-1/2 bg-text2 rounded-r-2xl flex flex-col px-5 py-1 gap-2'>
           ...
           <div className=' flex flex-row items-center justify-between'>
              ...
              <div className=' flex flex-row gap-1'>
                <div><button className="w-8 h-8 rounded-full backdrop-blur-lg bg-white/10 border border-white/20 flex items-center justify-center text-white text-gl hover:scale-110 transition"><a href='https://github.com/subhadeep104647/Love---Lattes'><FaGithub /></a></button></div>
